require = function r(a, s, o) {
    ...
    e = 0; e < o.length; e++) d(o[e]);
    return d
} ({
    1 : [function(e, l, t) { (function(e) {
            function t(n, l, e) {
    ...
    "biojs-vis-blasterjs": [function(r, e, t) {
        ...
        e.exports = n({
            constructor: function(e) {
                ...
                } else document.getElementById(t.opt.input).addEventListener("change",
                function(e) {
            ...
            _displayAlignments: function(e, o) {
                    ...
                    if (t) {
                        ...
                        n.onload = function(e) {
                            try {
                                ...
                                for (var r = ["blast-multiple-alignments", "blast-alignments-table", "blast-single-alignment"], a = 0; a < r.length; a++) for (var s = document.getElementById(r[a]); s.firstChild;) s.removeChild(s.firstChild);
                ...
                function k(e) {
                    return e.split("\n")[2].startsWith("<BlastOutput>") ?
                    function(e) {
                        for (var t = e.split("\n"), n = 0, l = 0; l < t.length; l++) if (t[l].includes("<Iteration_query-len>")) {
                            n = t[l].split(">")[1].split("</")[0];
                            break
                        }
                        return n
                    } (e) : function(e) {
                        for (var t = e.split("\n"), n = 0, l = 0; l < t.length; l++) if (t[l].startsWith("Length=")) {
                            n = t[l].split("=")[1];
                            break
                        }
                        return n
                ...
                function c(e) {
                    return e.split("\n")[2].startsWith("<BlastOutput>") ?
                    function(e) {
                        for (var t = e.split("\n"), n = [], l = 0; l < t.length; l++) if (t[l].startsWith("<Hit>")) {
                            for (var i = "",
                            r = l; r < t.length && (i += t[r], !t[r].includes("</Hit>")); r++);
                            for (var a = i.split("<Hit_id>")[1].split("</")[0], s = i.split("<Hit_def>")[1].split("</")[0], o = a.concat(" ").concat(s), d = i.split("<Hit_len>")[1].split("</")[0], p = [], c = i.split("<Hit_hsps>")[1].split("</Hit_hsps>")[0].split("</Hsp>"), u = 0; u < c.length - 1; u++) {
                                ...
                                y = f / g * 100;
                                if (t[3].includes("<BlastOutput_program>blastn</BlastOutput_program>")) var v = "N/A",
                        ...
                        for (var t = e.split("\n"), n = [], l = 0; l < t.length; l++) if (t[l].startsWith(">")) {
                            ...
                            do {
                                ...
                                for (a += 9; t[a].startsWith("Query");) {
                                    ...
                                    if (T.length > H.length) for (var F = T.length - H.length,
                                    w = 0; w < F; w++) H = " " + H;
                                    b += H,
                                    a += 4
                                }
                ...
                function _(e, t) {
                    for (var n = 0,
                    l = u(e), i = 0; i < l.length; i++) n += parseInt(100 * (l[i].end - l[i].start + 1) / t);
                    return n
                }
                function u(e) {
                    for (var t = [], n = 0; n < e.length; n++) parseInt(e[n].queryStart) > parseInt(e[n].queryEnd) ? t.push({
                    ...
                    return function(e) {
                        for (var t = [], n = 0; n < e.length; n++) {
                            for (var l = e[n][0].start, i = e[n][0].end, r = 0; r < e[n].length; r++) e[n][r].start < l && (l = e[n][r].start),
                        ...
                        t[n] = [e[0]];
                        for (var l = 1,
                        i = e.length; l < i; l++) e[l].start >= e[l - 1].start && e[l].start < (0 != (r = t[n]).length && (r.sort(function(e, t) {
                            return e.end < t.end ? 1 : e.end > t.end ? -1 : 0
                        }), r[0].end)) ? t[n].push(e[l]) : t[++n] = [e[l]];
                        var r;
                        return t
                    } (t))
                }
                ...
                function m(e) {
                    ...
                    for (t = 0; t < l.length; t++) l[t].style.fontWeight = "normal",
                ...
                function p(e) {
                    ...
                    return t.style.marginBottom = "5px",
                    ...
                    l = function(e, t) {
                        ...
                        if (4 < t) if (t % 5 == 0) e = a(e, 5, t / 5, 100);
                        else {
                            var l = 500 / (5 + t % 5 / 5);
                ...
                function E(e, t, n) {
                    ...
                    for (var a = 0; a < l.length; a++) {
                        ...
                        } else p = parseInt(500 * (l[a].start - l[a - 1].end) / n),
                ...
                function h(e) {
                    ...
                    function(e) {
                        ...
                        for (var t = e.split("\n"), n = "", l = 0; l < t.length; l++) if (t[l].startsWith("Query=")) {
                            for (n = t[l].split("=")[1], l++; ! t[l].startsWith("Length=");) n = n + " " + t[l],
                            l++;
                            break
                        }
                        return n
                ...
                function y(e) {
                    ...
                    return t.style.textAlign = "right",
                    ...
                    n.onclick = function() { !
                        function(e) {
                            ...
                            for (var n = 0; n < e.length; n++) t += e[n].description,
                            t += "; ",
                            t += e[n].hsp[0].score,
                            t += "; ",
                            t += e[n].hsp[0].eValue,
                ...
                function r(n) {
                    ...
                    for (e = 0; e < t.length; e++) t[e].style.fontWeight = "normal",
                ...
                function w(e, t, n, l) {
                    ...
                    d.innerHTML = e.description, d.style.paddingLeft = "15px", d.style.fontWeight = "bold", d.style.fontSize = "15px", d.style.fontFamily = "Helvetica,Arial,sans-serif", p.style.paddingTop = "20px", p.style.fontSize = "14px", p.style.textAlign = "center", p.style.fontFamily = "Helvetica,Arial,sans-serif", p.style.display = "table", p.style.margin = "0px auto", p.style.width = "100%", c.innerHTML = "<b>Score:</b></br>" + e.hsp[l].score, c.style.float = "left", c.style.width = "20%", u.innerHTML = "<b>Expect:</b></br>" + e.hsp[l].eValue, u.style.float = "left", u.style.width = "20%", m.innerHTML = "<b>Identities:</b></br>" + e.hsp[l].identities + "%", m.style.float = "left", m.style.width = "20%", h.innerHTML = "<b>Positives:</b></br>" + e.hsp[l].positives + "%", h.style.float = "left", h.style.width = "20%", f.innerHTML = "<b>Gaps:</b></br>" + e.hsp[l].gaps + "%", f.style.float = "left", f.style.width = "20%", g.style.clear = "both", p.appendChild(c), p.appendChild(u), p.appendChild(m), p.appendChild(h), p.appendChild(f), p.appendChild(g), a.appendChild(y), a.appendChild(v), a.appendChild(b), r.appendChild(d), r.appendChild(p), r.appendChild(a), i.appendChild(r), 1 < n) {
