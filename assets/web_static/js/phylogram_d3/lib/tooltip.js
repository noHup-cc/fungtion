...
// https://github.com/emiguevara/d3-tip/blob/master/index.js
...
(function (root, factory) {
  ...
  return function() {
    ...
    tip.show = function(d, idx, absolute) {
      ...
      console.log(content)
//          
      content = content.replace(/<p><p class="tip-row"><span class="tip-meta-title">- Highlight<\/span>: <span class="tip-meta-name">-<\/span>/,"")
      content = content.replace(/<p><p class="tip-row"><span class="tip-meta-title">- Highlight<\/span>: <span class="tip-meta-name">.*?<\/span>/,"")
      content = content.replace(/<span class="tip-meta-title">- SpeciesFirst<\/span>: <span class="tip-meta-name">.*?<\/span>/,"")
      var reg = new RegExp( 'undefined' , "g" )
      content = content.replace(reg,"-")
//      
          nodel.html(content)
          .style({ opacity: 0.8,'pointer-events': 'all' })
      if(content.indexOf("pAcr") != -1 || content.indexOf("Query") != -1){
...
//          //.style({ opacity: 0, 'pointer-events': 'none' })
      ...
      var y = d3.event.pageY - scrollTop;
