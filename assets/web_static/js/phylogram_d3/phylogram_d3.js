...
function init(dat, div, options, page) {
...
//    console.log(newick)
    ...
    console.log("------");
    // render tree
    buildTree(page,div, newick, options, function() { updateTree(); });
...
function buildTree( page, div, newick, opts, callback) {
...
//        console.log(parsed[0]);
    ...
    // build GUI
    var gui = buildGUI(page,div, opts);
